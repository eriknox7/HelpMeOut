package com.example.helpmeoutapp.ServiceFragments;
...
import com.example.helpmeoutapp.CafeAdapter;
import com.example.helpmeoutapp.CafeModel;
import com.example.helpmeoutapp.R;
...
public class CyberCafeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cyber_cafe, container, false);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Services").child("Cyber Cafe");
        fetchCafeData();
