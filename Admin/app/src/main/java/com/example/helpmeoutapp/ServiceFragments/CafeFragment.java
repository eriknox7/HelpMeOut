...
import com.example.helpmeoutapp.CyberCafeAdapter;
import com.example.helpmeoutapp.CyberCafeModel;
...
public class CafeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Services").child("Cafe");
        fetchCafeData();
