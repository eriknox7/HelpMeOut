...
public class CyberCafeAdapter extends RecyclerView.Adapter<CyberCafeAdapter.ViewHolder> {
    private Context context;
    private List<CafeModel> cyberCafeList;

    public CyberCafeAdapter(Context context, List<CafeModel> cyberCafeList) {
        this.context = context;
        this.cyberCafeList = cyberCafeList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        CafeModel model = cyberCafeList.get(position);
